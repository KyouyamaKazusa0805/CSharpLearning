...
* [ ] C# 2 语法
  ...
  * [x] 委托类型扩展
    * [x] 073 C# 2 之匿名函数
    * [ ] 074 C# 2 之方法组转委托（`new D(M)` 简化为 `M`）
    * [ ] 075 C# 2 之委托逆变参数和协变返回
  * [ ] 命名空间优化
    * [ ] 076 C# 2 之类型和命名空间别名
    * [ ] 077 C# 2 之外部别名
  * [ ] 类型语法优化
  ...
  * [ ] 语句扩展
    * [ ] 080 C# 2 之迭代器语句
    * [ ] 081 C# 2 之 `bool` 类型实例的 `switch` 语句用法
  * [ ] 零碎语法
    * [ ] 082 C# 2 之定长缓冲区字段
    * [ ] 083 C# 2 之允许 getter 和 setter 访问级别不同
    * [ ] 084 C# 2 之 `#pragma warning` 警告禁用指令
    * [ ] 085 C# 2 之 `module` 特性目标说明符
